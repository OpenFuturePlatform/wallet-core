...
$dataToBeEncrypted = "ace5e6e1b60a3f8c37445377d97b3ba30d99e8de012af9c305d78e40db3dda73";
echo "Data To Be Encrypted: " . $dataToBeEncrypted . "\n";
$encrypt = $open->encrypt($dataToBeEncrypted, "password");
echo "Encrypted Data: " . $encrypt . "\n";
$decrypt = $open->decrypt($encrypt, "password");
