...
jstring JNICALL Java_wallet_core_jni_HDWallet_getExtendedPrivateKeyAccount(JNIEnv *env, jobject thisObject, jobject purpose, jobject coin, jobject version, jint account) {
    jclass thisClass = (*env)->GetObjectClass(env, thisObject);
    jfieldID handleFieldID = (*env)->GetFieldID(env, thisClass, "nativeHandle", "J");
    struct TWHDWallet *instance = (struct TWHDWallet *) (*env)->GetLongField(env, thisObject, handleFieldID);
    ...
    jint versionValue = (*env)->CallIntMethod(env, version, versionValueMethodID);
    jstring result = NULL;
    TWString *resultString = TWHDWalletGetExtendedPrivateKeyAccount(instance, purposeValue, coinValue, versionValue, account);
    result = TWStringJString(resultString, env);
    (*env)->DeleteLocalRef(env, purposeClass);
    (*env)->DeleteLocalRef(env, coinClass);
    (*env)->DeleteLocalRef(env, versionClass);
...
jstring JNICALL Java_wallet_core_jni_HDWallet_getExtendedPublicKeyAccount(JNIEnv *env, jobject thisObject, jobject purpose, jobject coin, jobject version, jint account) {
    jclass thisClass = (*env)->GetObjectClass(env, thisObject);
    jfieldID handleFieldID = (*env)->GetFieldID(env, thisClass, "nativeHandle", "J");
    struct TWHDWallet *instance = (struct TWHDWallet *) (*env)->GetLongField(env, thisObject, handleFieldID);
    ...
    jint versionValue = (*env)->CallIntMethod(env, version, versionValueMethodID);
    jstring result = NULL;
    TWString *resultString = TWHDWalletGetExtendedPublicKeyAccount(instance, purposeValue, coinValue, versionValue, account);
    result = TWStringJString(resultString, env);
    (*env)->DeleteLocalRef(env, purposeClass);
    (*env)->DeleteLocalRef(env, coinClass);
    (*env)->DeleteLocalRef(env, versionClass);
